...
export class InitCommand extends BaseCommand<InitOptions> {
  ...
  private async interactiveSetup(projectInfo: any, options: InitOptions): Promise<any> {
  ...
  private async templateSetup(templateName: string, projectInfo: any): Promise<any> {
  ...
  private defaultSetup(projectInfo: any, options: InitOptions): any {
    return {
      project: {
  ...
  private async createTomlConfig(projectPath: string, config: any): Promise<string> {
  ...
  private generateTomlContent(config: any): string {
    const lines: string[] = [
  ...
  private async createMariaMd(projectPath: string, config: any, projectInfo: any): Promise<string> {
  ...
  private generateMariaMdContent(config: any, projectInfo: any): string {
...
`;
  ...
  private displaySummary(config: any, projectInfo: any): void {
