 ...
 */
export function generateNeo4jJWT(userEmail: string, options: JWTOptions): string {
 ...
 */
export function getNeo4jBloomURL(instanceId: string, jwt: string, query?: string): string {
