...
export const TASKROUTING: Record<TaskType, string[]> = {
...
export const _PROVIDER_PRIORITY_MODES = {
  "privacy-first": [
    "lmstudio",
    "ollama",
    "vllm",
...
export function getRecommendedModel(
  ...
  const _recommendations = TASK_ROUTING[_taskType] || TASK_ROUTING.chat;

  for (const modelId of _recommendations) {
...
export function isCloudProvider(providerName: string): boolean {
  return ["openai", "anthropic", "google", "groq", "grok"].includes(
    providerName,
  );
}
