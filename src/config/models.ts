...
export const TASK_ROUTING: Record<TaskType, string[]> = {
  ...
  cost_effective: ['gemini-2.5-flash', 'claude-3-5-haiku-20241022', 'gpt-4o-mini', 'mixtral-8x7b-32768'],
  privacy: ['gpt-oss-120b', 'qwen2.5:32b', 'japanese-stablelm-2-instruct-1_6b', 'mistral-7b-instruct'],
...
export function getRecommendedModel(taskType: TaskType, availableModels: string[]): string | undefined {
