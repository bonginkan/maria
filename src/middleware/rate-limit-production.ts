/**
 * Production-Grade Rate Limit Middleware
 * 
 * Features:
...
interface RateLimitConfig {
  ...
  windowMs?: number;     // For backward compatibility
}
...
// Separate buckets for long-running operations
const OPERATION_LIMITS: Record<string, RateLimitConfig> = {
  '/operations:FREE': { capacity: 5, refillRate: 2, burstAllowed: 1 },     // 2 polls/s
  '/operations:STARTER': { capacity: 10, refillRate: 5, burstAllowed: 2 },  // 5 polls/s
  '/operations:PRO': { capacity: 20, refillRate: 10, burstAllowed: 5 },     // 10 polls/s
};
