...
export function getErrorMessage(error: unknown): string {
  ...
  if (isDictionary(_error) && typeof _error["message"] === "string") {
...
export function hasProperty<K extends string>(
  ...
  return isDictionary(_obj) && key in _obj;
}
...
export function assertString(
  ...
  if (!isString(_value)) {
    throw new Error(_message || "Value is not a string");
  }
}
...
export function assertNumber(
  ...
  if (!isNumber(_value)) {
    throw new Error(_message || "Value is not a number");
  }
}
...
export function assertArray(
  ...
  if (!isArray(_value)) {
    throw new Error(_message || "Value is not an array");
  }
}
...
export interface CommandComponentProps extends BaseComponentProps {
  onExecute?: (_result: unknown) => void;
