...
// Note: Core services removed from re-exports to prevent circular dependencies
// Import core services directly from their modules:
// import { AutonomousCodingAgentService } from './core/AutonomousCodingAgentService'
// import { VisualModeDisplayEngine } from './core/VisualModeDisplayEngine'

// Type guards
export const _isTask = (obj: unknown): obj is Task => {
  return obj && typeof obj.id === "string" && typeof obj.title === "string";
};

export const _isSOW = (obj: unknown): obj is SOW => {
  return obj && typeof obj.id === "string" && Array.isArray(obj.tasks);
};

export const _isCodingMode = (obj: unknown): obj is CodingMode => {
