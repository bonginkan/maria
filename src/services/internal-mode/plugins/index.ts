...
// Plugin Framework
export { BaseModePlugin } from "./BaseModePlugin";
export type {
  ModeCategory,
  ModeContext,
  ModeResult,
...
export { ModePluginRegistry } from "./ModePluginRegistry";
export type {
  PluginMetadata,
  ModeSelection,
} from "./ModePluginRegistry";
export { ModeTransitionEngine } from "./ModeTransitionEngine";
export type {
  TransitionRequest,
  TransitionResult,
  SessionState,
 ...
 */
export const _DEFAULT_MODE_CONFIGS = {
