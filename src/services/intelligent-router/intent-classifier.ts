...
export class IntentClassifier {
  private commandMappings: CommandPattern[] = [
    ...
    // Priority 9: コード生成
    {
      ...
      keywords: ['コード', 'code', '実装', 'implement', 'バグ', 'bug', 'エラー', 'error', 'API', '機能', 'function', 'リファクタリング', 'refactor'],
   ...
   * 動画生成パラメータ抽出
   */
  private extractVideoParams(input: string): Record<string, any> {
   ...
   * 画像生成パラメータ抽出
   */
  private extractImageParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
   ...
   * コード生成パラメータ抽出
   */
  private extractCodeParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
   ...
   * テストパラメータ抽出
   */
  private extractTestParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
   ...
   * レビューパラメータ抽出
   */
  private extractReviewParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
   ...
   * コミットパラメータ抽出
   */
  private extractCommitParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
   ...
   * デプロイパラメータ抽出
   */
  private extractDeployParams(input: string): Record<string, any> {
    const params: Record<string, any> = {};
