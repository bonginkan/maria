...
export type { ModeCategory } from "./ModeIndicator.js";
...
export {
  ...
  ShortcutCategory,
} from "./KeyboardShortcutHandler.js";
 ...
 * 統合CLIシステムのファクトリー関数
 */
export async function createIntegratedCLI(
  config?: Partial<IntegratedCLIConfig>,
) {
...
export const _BUILD_DATE = new Date().toISOString();

/**
 * デフォルト設定
 */
export const DEFAULTCONFIG: IntegratedCLIConfig = {
  layout: {
    width: 124,
    responsive: true,
  },
