...
export class MariaInternalModeService {
  private connection: Connection;
  private currentMode: InternalMode;
  private modes: Map<string, InternalMode>;
  ...
  private initializeModes(): Map<string, InternalMode> {
    const modes = new Map<string, InternalMode>();
