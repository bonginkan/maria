...
export class MariaSecurityReviewer {
  ...
  async analyze(code: string, language: string): Promise<SecurityIssue[]> {
    try {
  ...
  private checkSecurityPatterns(code: string, language: string): SecurityIssue[] {
