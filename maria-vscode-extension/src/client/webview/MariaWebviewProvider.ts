...
export class MariaWebviewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'maria.chatView';
  
  private _view?: vscode.WebviewView;
  private _extensionUri: vscode.Uri;
  private _configManager: any;
  private _licenseStatus: any;
  ...
  private async _handleCommand(command: string, args: any): Promise<void> {
    try {
  ...
  private async _exportChatHistory(): Promise<void> {
