...
var simple_interactive_cli_exports = {};
__export(simple_interactive_cli_exports, {
  MariaCLI: () => MariaCLI
});
module.exports = __toCommonJS(simple_interactive_cli_exports);
...
//# sourceMappingURL=simple-interactive-cli.cjs.map